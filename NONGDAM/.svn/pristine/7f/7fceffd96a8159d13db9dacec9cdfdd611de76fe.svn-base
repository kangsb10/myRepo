...
<!--                         </div> -->
                        <div style="display:inline;">
                            ...
                            <c:if test="${!empty login_mberInfo }">
                             	<div style="display:inline;float:left; margin-right: 20px; margin-left: 10px; margin-top: 15px;"><a href="/join/loginOut.do"><p id="a">로그아웃   | </p></a></div>
	                   			<div style="display:inline;float:left; margin-top: 15px; "><a href="${pageContext.request.contextPath }/user/member/proFile/proFile.do"><p id="a">마이페이지</p></a></div>
                            </c:if>
                        </div>
                    </div>
                </a>
...
<%-- 	                   	<li><a href="${pageContext.request.contextPath }/join/findInfomation.do">ID/PW찾기</a></li>     --%>
	                    <li><a href="${pageContext.request.contextPath }/user/notice/noticeList.do">공지사항</a></li>
	                    <li><a href="components.html">농업IN</a></li>
	                    <li><a href="${pageContext.request.contextPath }/user/kh/khList.do">같이키워요</a></li>
	                    <li><a href="${pageContext.request.contextPath }/user/cm/communityList.do">커뮤니티</a></li>
	                    <li><a href="${pageContext.request.contextPath }/user/shop/shopList.do">쇼핑몰</a></li>
	                    <li><a href="components.html">고객센터</a></li>
	                    <li><a href="http://www.creative-tim.com/product/get-shit-done-kit" class="btn btn-round btn-default">응애~</a></li>
	               </ul>
	            </c:if>
       			<c:if test="${!empty login_mberInfo }">
	              <ul class="nav navbar-nav navbar-right" style=" background-color: black; opacity: 0.9;">
<%-- 	                   	<li><a href="${pageContext.request.contextPath }/join/loginOut.do">로그아웃</a></li> --%>
<%-- 	                   	<li><a href="${pageContext.request.contextPath }/user/member/proFile/proFile.do">마이페이지</a></li>     --%>
	                    <li><a href="${pageContext.request.contextPath }/user/emergencymbtlnum/emergencymbtlnumList.do?mber_id=${login_mberInfo.mber_id}">알림</a></li>
	                    <li><a href="${pageContext.request.contextPath }/user/payment/paymentList.do?mber_id=${login_mberInfo.mber_id}">구매내역</a></li>
	                    <li><a href="${pageContext.request.contextPath }/user/customercenter/statementList.do?mber_id=${login_mberInfo.mber_id}">문의내역</a></li>
	                    <li><a href="${pageContext.request.contextPath }/user/farmingdiary/farmingDiaryList.do?mber_id=${login_mberInfo.mber_id}">영농일지</a></li>
	                    <li><a href="${pageContext.request.contextPath }/user/sfms/farmList.do?mber_id=${login_mberInfo.mber_id }">스마트팜</a></li>
	                    <li><a href="${pageContext.request.contextPath }/user/shop/shopList.do">쇼핑몰</a></li>
	                    <li><a href="http://www.creative-tim.com/product/get-shit-done-kit" class="btn btn-round btn-default">응애~</a></li>
	               </ul>
               </c:if>
