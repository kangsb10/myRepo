...
<form name="updateForm" class="form-horizontal" role="form" action="${pageContext.request.contextPath }/admin/member/updateMember.do" method="post">
	...
	<div class="form-group">
		<label class="control-label col-sm-2" for="mber_ncnm">닉네임:</label>
			<input name="mber_ncnm" value="${memberInfo.mber_ncnm }">
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		<label class="control-label col-sm-2" for="mber_seed">씨앗:</label>
			<input type="text" name="mber_seed" value="${memberInfo.mber_seed }">
	</div>
