...
// 			contentType: "application/x-www-form-urlencoded; charset=UTF-8", 
		...
		$(".examBtn").on("click",function(e) {
			e.preventDefault();
			var itt = $(this.form).find("input[name=ittNM]").val();
			var ex = $(this.form).find("input[name=addEX]").val();
			...
			var html = 
				"<tr>"
					+ "<td>"
						+ "<label class='checkbox' for='checkbox1'>"
							+ "<input type='checkbox' value='test' id='checkbox2' data-toggle='checkbox'>"
						+ "</label>"
					+ "</td>"
					+ "<td>" + ex + "</td>"
				+ "</tr>";
			setTimeout(function(){
				$("#" + clickedBtn).next().next().find("tbody").append(html);
				$("input[name=addEX]").val("");	
			},1000);
											...
											<form action="" method="POST">
												<div class="form-body pal">
													...
													<table class="table">
														<thead>
															<tr>
																<th style="padding-left:40px;">chk</th>
																<th style="padding-left:110px;">Example</th>
															</tr>
														</thead>
