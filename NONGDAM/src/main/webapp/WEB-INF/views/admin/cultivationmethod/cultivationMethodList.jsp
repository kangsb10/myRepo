...
<form action="/admin/cultivationmethod/cultivationMethodList.do" method="post" class="form-inline">
...
$(function(){
	...
	$("#cultlvationMethodTBL tr").click(function(){
		...
		$(location).attr("href", "${pageContext.request.contextPath}/admin/cultivationmethod/cultivationMethodView.do?ctvt_mth_no=" + ctvt_mth_no);		
