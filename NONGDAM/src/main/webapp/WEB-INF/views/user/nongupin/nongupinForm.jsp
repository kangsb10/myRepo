                    ...
                    <div class="p-ins">
                        ...
                        <ul style="margin-top: 50px;">
                        	...
                        	<li style="float:left;  padding-left: 10px;"> <label class="" for="farm_in_sj" style="">제 목 : </label></li>
                       		<li style="float:left; padding-left: 18px;"> <input type="text" class="form-control" name="farm_in_sj" id="farm_in_sj"  placeholder="제목 입력" style="position: relative; top:-5px; width: 280px;  height: 30px;"></li>
                        </ul>
	                     </div>
                        <div class="row">
                        <ul style="margin-top: 10px;">
                   			...
                   			<li style="float:left; padding-left: 12px;"> <input type="text" class="form-control" name="mber_ncnm" id="mber_ncnm"  value="${login_mberInfo.mber_ncnm}" disabled="disabled" style="text-align:center; width:100px; position:relative; top: -5px; height: 30px;"></li>
	                    </ul>
	                     </div>
                        <div class="row">
                        <ul style="margin-top: 10px;">
                   			...
                   			<li style="float:left; padding-left: 10px;"> 
                   				<select style="float:left; margin-left: 15px;" id="farm_in_gu" name="farm_in_gu"> 
                   					<c:forEach items="${guNM }" var="guNM">
										<option style="text-align: center;" value="${guNM.farm_in_nm }">${guNM.farm_in_nm }</option>
									</c:forEach>
								</select>
                   			</li>
	                    </ul>
						...
						<div class="row">
							<ul style="margin-top: 10px;">
								...
								<li style="float:left; padding-left: 18px;"> <input type="text" class="form-control" name="farm_in_seed" id="farm_in_seed"  placeholder="씨앗을 입력하세요" style="margin-left:10px; position: relative; top:-5px; width: 130px;  height: 30px;">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div style="border-top : 1px solid #585858; "></div>
                                <div style=" position: relative; top: 5px; ">
                                    <label style="margin-right: 5px;">해시태그 : </label><input type="text" class="farm_in_tag"  id="farm_in_tag" name="farm_in_tag" placeholder="해시태그를 입력하세요">
                                </div>
                            </div>
                        </div>
                        <div class="row">
...
var backUrl = document.referrer;
	 ...
	 $('form[name=insertForm]').submit(function(){
	      ...
	      $(this).attr('action', '/user/nongupin/insertNongupin.do'); 
