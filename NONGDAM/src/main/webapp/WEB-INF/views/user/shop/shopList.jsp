...
<%-- 							<c:forEach items="${shoppingList }" var="shoppingList" begin="1" end="1"> --%>
								<div class="item active">
									<div class="col-sm-6">
										<img src="/files/gramokson.jpg" class="girl img-responsive" alt="" style=" border-radius: 10px; height: 300px; margin: 0 auto;"/>
													...
													<div class="productinfo text-center">
														...
														<div style="position: relative; float:left; top:-10px; left: -50px;">
															<a href="/user/shop/shopView.do?goods_id=${shoppingList.goods_id }" style="float: left;  margin-bottom :20px; height: 60px;">
																		<img src="/img/shop/images/list/sangsebogi.png" style="position: relative; margin-left:90px;  width: 120px; margin-top: -11px; "  class="" alt="" /></a>
