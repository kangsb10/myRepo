...
var writr =  '${customerCenterInfo.mber_id}';
 $(function(){
	 ...
	 $('#deleteBt').click(function(){//삭제
	       if(mber_id == writr){
	          $(location).attr('href', '${pageContext.request.contextPath}/user/customercenter/deleteCustomerCenter.do?cstmr_cnter_no=${customerCenterInfo.cstmr_cnter_no}');
	       }else{
	...
	$('form[name=updateForm]').submit(function() {
		 if(mber_id == writr){
			...
			var search_keycode = '${search_keycode }';
			var currentPage = '${currentPage }';
			$(this).attr('action', '${pageContext.request.contextPath}/user/customercenter/updateCustomerCenterForm.do?cstmr_cnter_no=${customerCenterInfo.cstmr_cnter_no}' + '&search_keyword='+search_keyword+'&search_keycode='+search_keycode+'&currentPage='+currentPage);
	       }else{
