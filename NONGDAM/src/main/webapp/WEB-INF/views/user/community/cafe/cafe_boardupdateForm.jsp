...
<div id="" style="position: relative; top: 70px;">
	<div class="">
		<ul >
			...
			<li style="position: relative; left: 10px; top: -5px; font-size: 20px; color: #0B3B24; float: left;"> 글 수정</li>
		</ul>
                    ...
                    <div class="p-ins">
                        ...
                        <ul style="margin-top: 50px;">
                        	...
                        	<li style="float:left;  padding-left: 10px;"> <label class="" for="bbs_sj" style="">제 목</label></li>
                       		<li style="float:left; padding-left: 18px;"> <input type="text" class="form-control" name="bbs_sj" id="bbs_sj" value="${cafeListInfo.bbs_sj }" placeholder="제목 입력" style="position: relative; top:-5px; width: 100px;  height: 30px;"></li>
                        </ul>
	                     </div>
                        <div class="row">
                        <ul style="margin-top: 10px;">
                   			...
                   			<li style="float:left; padding-left: 10px;"> <input type="text" class="form-control" name="cafe_mber_ncnm" id="cafe_mber_ncnm"  value="${cafeName.cafe_mber_ncnm }" disabled="disabled" style=" position:relative; top: -5px; height: 30px;"></li>
	                    </ul>
	                     </div>
	                     <div class="row">
	                        <ul style="margin-top: 10px;">
		                       	<li style="float:left; padding-left: -10px;"> <img src="/img/view/view_reg.png" width="25px" height="20px"></li>
		                       	<li style="float:left;  padding-left: 10px;"> <label class="" for="" style="">게시판</label></li>
	                   			<li style="float:left; padding-left: 10px;"> 
									<input type="text" class="form-control" name="" id=""  value="${cafeInfo.bbs_creat_sj }" disabled="disabled" style=" position:relative; top: -5px; height: 30px;">
								</li>
		                    </ul>
	                    </div>
                        <div class="row">
...
// 	      });
	      ...
	      if($('#bbs_cn').val() == null || $('#bbs_cn').val().trim() == ""){
		         alert("내용을 입력하세요");
		         return false;
		      }
	      
	      $(this).attr('action', '/user/cm/updateGle.do?'); 
...
//           var bbs_sj = $('#bbs_sj').val();
	      ...
	      $(this).append('<input type="hidden" name="cafe_mber_id" value="${login_mberInfo.mber_id}"></input>'); //<==form 셀렉팅하기
	      $(this).append('<input type="hidden" name="bbs_creat_no" value="${cafeInfo.bbs_creat_no}"></input>'); //<==form 셀렉팅하기
          $(this).append('<input type ="hidden" name="bbs_no" value="${cafeListInfo.bbs_no }"></input>');
          $(this).append('<input type ="hidden" name="cafe_mber_ncnm" value="${communityInfo.cafe_mber_ncnm }"></input>');
          $(this).append('<input type ="hidden" name="cmmnty_no" value="${communityInfo.cmmnty_no }"></input>');
