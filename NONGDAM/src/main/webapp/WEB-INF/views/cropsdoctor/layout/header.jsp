...
<!--                         <div > -->
                        <div class="logo">
                            <img src="/img/spring1234.png" onclick="/user/main/main_mod.do">
                        </div>
<!--                         <div class="brand"> -->
...
<!--                         </div> -->
                        <div style="display:inline;">
                            ...
                            <c:if test="${!empty login_mberInfo }">
                             	<a class="a" href="/join/loginOut.do"><font color="white">로그아웃</font></a>
	                   			<a class="a" href="/user/member/proFile/proFile.do"><font color="white">마이페이지</font></a>
                            </c:if>
                        </div>
                    </div>
                </a>
