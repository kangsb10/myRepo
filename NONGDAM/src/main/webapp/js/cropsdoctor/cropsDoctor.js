	...
	$("#imgForm").ajaxForm({
        ...
        success : function(result){
        	...
        	if(result.isNormal == true){
        		resultHtml = "정상으로 나온다. 흙뭍어있으면 씻어서 다시 올려라";
		    ...
		    "<div class='row'>" + 
		        "<div class='col-sm-6'>" + 
		            "<div class='form-group'>" + 
		                ...
		                "</br>알람내용 : " + 
		                "</br>" + 
		                "<input type='text' name='alarmDetail' style='width:250px'>" + 
		                "</br>" + 
		                "<div class='row'>&nbsp</div>" +
		                "<div class='row' style='padding-left:120px;'>" +
		                	"<button class='btn btn-info' id='alarmBtn' type='button'>설정</button>" +
		                "</div>" + 
		            "</div>" + 
		        "</div>" + 
	...
	var jqueryFnc = 
        ...
        "$(function () {" +
        	"$('#" + goodsId + "').on('click',function(){" +
        		"$(location).attr('href', '/user/shop/shopView.do?goods_id=" + goodsId + "');" + 
