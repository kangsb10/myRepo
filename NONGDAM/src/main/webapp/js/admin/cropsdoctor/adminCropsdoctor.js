...
function getIntentList(){
	...
	$.ajax({
		...
		success : function(result){
			...
			var resultHtml = "";
			console.log("intentList 출력");
			console.log("intentsArr.length : " + intentsArr.length);
			for(var i = 0; i < intentsArr.length; i++){
				var intent = intentsArr[i][0];
				var desc = intentsArr[i][1];
				console.log("intentArr[" + i + "][0] : " + intentsArr[i][0]);
				console.log("intentArr[" + i + "][1] : " + intentsArr[i][1]);
				var cnt = i + 1;
