...
public interface ICommunityDao{
	...
	//카페 등록
	public String communityIns(CommunityVO communityInfo,List<CommunityFileItemVO> communityFileItemList) throws Exception;
	// 중분류
	...
	public String insertCafeBoardInfo(CommunityVO communityInfo, 
			  List<BulletinBoardFileItemVO> bulletinBoardFileItemList) throws Exception;
	// 게시판 뷰
